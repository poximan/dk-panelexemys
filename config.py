...
# ---------------------------------------------------------
ALARM_EMAIL_RECIPIENT = ["midestino@correo.com"]
ALARM_EMAIL_SENDER = "micorreo@correo.com"    # Remitente del email (generalmente debe coincidir con SMTP_USERNAME)
ALARM_EMAIL_SUBJECT_PREFIX = "[Exemys] "        # Prefijo para el asunto del email

# Detalles del servidor SMTP
SMTP_SERVER = "post.correo.com" 
SMTP_PORT = 5                     # Puerto estándar para TLS (587) o SSL (465). Si no estás seguro, prueba 587 primero.
SMTP_USERNAME = "micorreo@correo.com"
SMTP_PASSWORD = "micorreo"
